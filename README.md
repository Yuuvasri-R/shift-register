...
6.If the reset signal is not asserted, assign the value of sin to the first flip-flop (q[0]) and shift the values of q to the right. PROGRAM
...
<img width="1604" height="710" alt="Screenshot 2025-12-10 144414" src="https://github.com/user-attachments/assets/05245de9-a749-4ad3-a148-f3844a133b5e" />

**TIMING DIGRAMS FOR SISO Shift Register**
<img width="1280" height="692" alt="image" src="https://github.com/user-attachments/assets/a0cc6bd9-da3e-45c2-8829-5445a3ca842d" />
